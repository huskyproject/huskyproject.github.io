...
#include "navbar.h"
      ...
      <blockquote>
        Operating systems:
        <ul>
          <li>All supported platforms except 16 bit DOS.</li>
          <li>Requires a C++ compiler.</li>
        </ul>
        Dependencies:
        <ul>
           <li>None.
      ...
      <blockquote>
        <table cellpadding="5" cellspacing="0" border="0">
          ...
          <tr valign="top">
            <td><a href="http://cvs.physcip.uni-stuttgart.de/cvs2/current/diskpoll-current-latest.tar.gz"><tt>diskpoll-current-latest.tar.gz</tt></a></td>
      ...
      <blockquote>
        ...
        Also see the <a href="http://www.physcip.uni-stuttgart.de/tobi/projects/diskpoll.html">diskpoll page</a> of the author.
      </blockquote>
