...
#include "navbar.h"
      ...
      <h3>What is it?</h3>
      <blockquote>
        <strong>fidostat</strong> is a BinkD log file analyzer.
      </blockquote>
	 ...
	 and is viewable online at 
        <a href="http://husky.cvs.sourceforge.net/husky/fidostat/">
        http://husky.cvs.sourceforge.net/husky/fidostat/</a></p>
